        ...
        <div className="min-h-screen w-full bg-black">
          ...
          <div className="flex flex-col w-full">
            <main className="flex-1 w-full">
              <section id="home" className="w-full min-h-screen py-12">
                <Hero />
              </section>
              ...
              <section id="links" className="w-full py-12">
                <Container>
                  <Links />
                </Container>
              </section>

              <section id="banner" className="w-full relative overflow-hidden py-12">
                <Banner />
              </section>
