...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-16 bg-black overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,rgba(3,41,80,0.15)_0%,rgba(0,0,0,0)_60%)]"></div>
      
      {/* Animated background lines */}
      <div className="absolute inset-0 overflow-hidden opacity-20">
        <div className="absolute h-[1px] w-full bg-gradient-to-r from-transparent via-[#032950]/50 to-transparent top-[20%] animate-[pulse_4s_ease-in-out_infinite]"></div>
        <div className="absolute h-[1px] w-full bg-gradient-to-r from-transparent via-[#032950]/30 to-transparent top-[50%] animate-[pulse_5s_ease-in-out_infinite_1s]"></div>
        <div className="absolute h-[1px] w-full bg-gradient-to-r from-transparent via-[#032950]/20 to-transparent top-[80%] animate-[pulse_4.5s_ease-in-out_infinite_0.5s]"></div>
        
        <div className="absolute w-[1px] h-full bg-gradient-to-b from-transparent via-[#032950]/50 to-transparent left-[20%] animate-[pulse_4.5s_ease-in-out_infinite]"></div>
        <div className="absolute w-[1px] h-full bg-gradient-to-b from-transparent via-[#032950]/30 to-transparent left-[50%] animate-[pulse_5s_ease-in-out_infinite_0.7s]"></div>
        <div className="absolute w-[1px] h-full bg-gradient-to-b from-transparent via-[#032950]/20 to-transparent left-[80%] animate-[pulse_4s_ease-in-out_infinite_1.5s]"></div>
      </div>
      ...
      <div className="container mx-auto z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <p className="text-xl text-gray-400 mb-8 border-l-2 border-[#032950] pl-4">
              Student • Innovator • Tech Enthusiast
            </p>

            <div className="space-y-4 mb-8 backdrop-blur-sm bg-black/30 p-5 rounded-lg border border-[#032950]/10 hover:border-[#032950]/30 transition-all duration-300">
              <div className="flex items-center group">
                <Mail className="w-5 h-5 text-[#032950] mr-3 group-hover:animate-pulse" />
              ...
              <div className="flex items-center group">
                <Phone className="w-5 h-5 text-[#032950] mr-3 group-hover:animate-pulse" />
                <a href="tel:+919989306597" className="text-gray-400 hover:text-white hover:underline transition-colors">
                  +91 9989306597
                </a>
              </div>
              <div className="flex items-center group">
                <MapPin className="w-5 h-5 text-[#032950] mr-3 group-hover:animate-pulse" />
          ...
          <div className="hidden md:flex justify-center items-center">
            <div className="relative animate-float">
              <div className="absolute -inset-1 rounded-full bg-gradient-to-br from-[#032950] to-black opacity-30 blur-xl"></div>
