      ...
      <div className="container mx-auto z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <p className="text-xl text-gray-400 mb-8 border-l-2 border-[#ea384c] pl-4">
              Student • Innovator • Tech Enthusiast
            </p>

            <div className="space-y-4 mb-8 backdrop-blur-sm bg-black/30 p-5 rounded-lg border border-[#ea384c]/10 hover:border-[#ea384c]/30 transition-all duration-300">
            ...
            <div className="flex space-x-5">
              <a href="https://www.linkedin.com/in/ruthwikredd/" target="_blank" rel="noopener noreferrer" className="text-white opacity-70 hover:opacity-100 hover:text-[#ea384c] transition-all duration-300 hover:scale-110 transform">
                <Linkedin className="w-6 h-6" />
              </a>
              <a href="https://x.com/ruthwikreddy" target="_blank" rel="noopener noreferrer" className="text-white opacity-70 hover:opacity-100 hover:text-[#ea384c] transition-all duration-300 hover:scale-110 transform">
                <Twitter className="w-6 h-6" />
              </a>
              <a href="https://www.instagram.com/ruthwwikreddy/" target="_blank" rel="noopener noreferrer" className="text-white opacity-70 hover:opacity-100 hover:text-[#ea384c] transition-all duration-300 hover:scale-110 transform">
                <Instagram className="w-6 h-6" />
              </a>
              <a href="https://github.com/ruthwikredd" target="_blank" rel="noopener noreferrer" className="text-white opacity-70 hover:opacity-100 hover:text-[#ea384c] transition-all duration-300 hover:scale-110 transform">
          ...
          <div className="hidden md:flex justify-center items-center">
            <div className="relative animate-float">
              <div className="absolute -inset-1 rounded-full bg-gradient-to-br from-[#ea384c] to-black opacity-30 blur-xl"></div>
